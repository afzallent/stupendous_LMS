...
class Command(BaseCommand):
    help = 'Seed database with 5 courses and YouTube videos'

    def handle(self, *args, **options):
        self.stdout.write("\n" + "="*70)
        self.stdout.write("SEEDING DATABASE WITH 5 COURSES AND YOUTUBE VIDEOS")
        self.stdout.write("="*70 + "\n")

        # Ensure instructor exists
        self.stdout.write("Step 1: Creating/Getting Instructor User...")
        ...
        # Create categories
        self.stdout.write("Step 2: Creating Course Categories...")
        categories_data = [
        ...
        self.stdout.write("Step 3: Creating 5 Courses with YouTube Videos...\n")
